...
# Control Input
# Leg 1
#PosX_1 = (BodyCenterOffsetX_1 + CoxaLength + FemurLength + TibiaLength) * math.cos(math.radians(FeetAngle_1))
#PosY_1 = (BodyCenterOffsetY_1 + CoxaLength + FemurLength + TibiaLength) * math.sin(math.radians(FeetAngle_1))
PosZ_1 = 0

# Leg 2
PosX_2 = BodyCenterOffsetX_2 + CoxaLength + FemurLength
PosY_2 = 0
PosZ_2 = -TibiaLength

# Leg 3
PosX_3 = (BodyCenterOffsetX_3 + CoxaLength + FemurLength + TibiaLength) * math.cos(math.radians(FeetAngle_3))
PosY_3 = (BodyCenterOffsetY_3 + CoxaLength + FemurLength + TibiaLength) * math.sin(math.radians(FeetAngle_3))
PosZ_3 = 0
...
"""
"""
dxl_goal_position = center + CoxaAngle_12048
...
dxl_goal_position = center + FemurAngle_1
param_goal_position = [DXL_LOBYTE(DXL_LOWORD(dxl_goal_position)), DXL_HIBYTE(DXL_LOWORD(dxl_goal_position)), DXL_LOBYTE(DXL_HIWORD(dxl_goal_position)), DXL_HIBYTE(DXL_HIWORD(dxl_goal_position))]
...
dxl_goal_position = center + TibiaAngle_1
param_goal_position = [DXL_LOBYTE(DXL_LOWORD(dxl_goal_position)), DXL_HIBYTE(DXL_LOWORD(dxl_goal_position)), DXL_LOBYTE(DXL_HIWORD(dxl_goal_position)), DXL_HIBYTE(DXL_HIWORD(dxl_goal_position))]
dxl_addparam_result = groupSyncWrite.addParam(22, param_goal_position)

dxl_goal_position = center + TibiaAngle_2
param_goal_position = [DXL_LOBYTE(DXL_LOWORD(dxl_goal_position)), DXL_HIBYTE(DXL_LOWORD(dxl_goal_position)), DXL_LOBYTE(DXL_HIWORD(dxl_goal_position)), DXL_HIBYTE(DXL_HIWORD(dxl_goal_position))]
